...
- The local bridge process survives an unexpected SSH/Yamux disconnect and recreates the remote agent with bounded exponential backoff. A profile is reported as usable only while both the supervisor and its local compatibility endpoint are ready.
