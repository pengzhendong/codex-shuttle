...
mod unix {
    ...
    #[cfg(target_os = "linux")]
    use agent_process::existing_agent_processes;
    #[cfg(all(test, target_os = "linux"))]
    use agent_process::find_socket_owner;
    use agent_process::{active_agent_pid, process_exists, validate_agent_process};
    #[cfg(test)]
    use agent_process::{find_unix_socket_inode, is_agent_command_line};
