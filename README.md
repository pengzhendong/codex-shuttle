...
- **Version-bound releases** — new stable OpenAI Codex source tags are checked every 15 minutes; old Shuttle releases remain available.
...
GitHub Actions checks for stable OpenAI `rust-vX.Y.Z` tags every 15 minutes and
